                        ...
                        <div class="row g-0 align-items-center">
                                ...
                                <div class="col-12 col-md-4 text-center bg-white py-3 px-2">
                                    <a
                                        ...
                                        <img src="{{ asset('storage/' . $category->image) }}" alt="{{ $category->name }}"
                                            class="img-fluid rounded-3" style="max-height:100px;object-fit:contain;" itemprop="image">
                                    </a>
                                </div>
                            @endisset
                            <div class="col-12 col-md-8 p-3 @if (!isset($category->image)) ms-5 @endif">
                                <h2 class="h5 fw-bold mb-2"><a class="text-decoration-none text-dark" itemprop="url"
                                        href="{{ route('categories.show', ['productType' => $productType, 'category' => $category]) }}"><span itemprop="name">{{ $category->name }}</span></a>
                                </h2>
