    ...
    <div class="tab-content" id="productTabContent">
        ...
        <div class="tab-pane fade" id="how-buy" role="tabpanel">
            ...
            <ul>
                <li>Через форму на сайте: нажмите кнопку заказать в один клик в карточке товара, заполните данные и
                    нажмите «Заказать».</li>
                <li>По электронной почте: отправьте письмо на <a href="mailto:{{ $emails[0]->email }}"
                        class="text-decoration-none">{{ $emails[0]->email }}</a>,
                    прикрепите реквизиты вашей организации и укажите наименование интересующего товара.</li>
                <li>По телефону: позвоните по номеру <a href="tel:{{ $phoneNumbers[0]->number }}"
                        class="text-decoration-none">{{ $phoneNumbers[0]->number }}</a>, озвучьте специалисту
        ...
        <div class="tab-pane fade" id="pay" role="tabpanel">
            ...
            <p>Оставьте заявку на странице товара, через форму на сайте или по Email: <a
                    href="mailto:{{ $emails[0]->email }}" class="text-decoration-none">{{ $emails[0]->email }}</a>.
            </p>
        ...
        <div class="tab-pane fade" id="garanty" role="tabpanel">
            ...
            <p>Приобретая любое оборудование на сайте <a href="{{ route('home') }}">briks1.ru</a>, вы получаете
                гарантию
